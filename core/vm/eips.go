...
// enableEVMPlus applies EIP-? (EVMPlus opcodes)
func enableEVMPlus(jt *JumpTable) {
	jt[DECADD] = &operation{
		execute:     opDecAdd,
		constantGas: params.DEC_EMUL_GAS,
		dynamicGas:  gasEVMPlusDECADD,
