...
const (
	...
	DECEXP_PRECISION_GAS            uint64 = 100    // Once per DECEXP step instruction
	DECLOG2_FIXED_GAS               uint64 = 200    // Once per DECEXP instruction
	DECLOG2_PRECISION_GAS           uint64 = 200    // Once per DECEXP step instruction
	DECSIN_FIXED_GAS                uint64 = 100    // Once per DECEXP instruction
	DECSIN_PRECISION_GAS            uint64 = 100    // Once per DECEXP step instruction
)
